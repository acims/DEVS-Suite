...
import java.util.*;
	...
	public class SampleWC extends ServiceComposition{
		...
		public void SubscriberConstruct(){
			...
			lookupList.add(new ServiceLookup("Ski Resort", "ResortByCity", new Pair("String", "tempe"), 1));
			//lookupList.add(new ServiceLookup("VoiceComm", "qRate", new Pair("Hz", 220500), 60));
			ServiceSubscriber Subscriber1 = new ServiceSubscriber("Travel Agent", lookupList, 0.1);
