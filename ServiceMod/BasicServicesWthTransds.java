...
import java.util.*;
	...
	public class BasicServicesWthTransds extends ServiceComposition{
		...
		public void SubscriberConstruct(){
			...
			lookupList.add(new ServiceLookup("Sub1", "doNothing", new Pair("", "packetSize"), 1));
			ServiceSubscriber Subscriber1 = new ServiceSubscriber("Sub1", lookupList, 1);
			
			lookupList = new ArrayList <ServiceLookup> ();
			lookupList.add(new ServiceLookup("Sub2", "doNothing", new Pair("", "packetSize"), 1));
			ServiceSubscriber Subscriber2 = new ServiceSubscriber("Sub2", lookupList, 1);
			
			lookupList = new ArrayList <ServiceLookup> ();
			lookupList.add(new ServiceLookup("Sub3", "doNothing", new Pair("", "packetSize"), 1));
			ServiceSubscriber Subscriber3 = new ServiceSubscriber("Sub3", lookupList, 1);
