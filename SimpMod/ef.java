...
public void efConstruct(double int_arr_t,double observe_t){
    ...
    {
        preferredSize = new Dimension(444, 186);
        ((ViewableComponent)withName("g")).setPreferredLocation(new Point(144, 33));
        ((ViewableComponent)withName("t")).setPreferredLocation(new Point(48, 114));
    }
}
